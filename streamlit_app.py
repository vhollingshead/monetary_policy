...
def gini_coefficient():
    ...
    st.image("gini_formula.png", use_column_width=True)  # Replace with actual image
    ...
    st.image("economic_indicators.png", use_column_width=True)  # Replace with actual image
